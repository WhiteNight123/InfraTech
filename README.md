...
| 📜 notebook练习                                           | 详细说明                                                                                         | 难度   |
|:--------------------------------------------------------|:---------------------------------------------------------------------------------------------|:-----|
| [chunked_prefill_and_flash_decoding.ipynb](./llm_infer) | [ChunkedPrefill&FlashDecoding原理详解](https://zhuanlan.zhihu.com/p/1988996116017086993)         | ⚡️⚡️ |
| [vllm_basic_scheduler.ipynb](./llm_infer)               | [vLLM Scheduler逻辑难啃？先手搓一个基础调度器](https://zhuanlan.zhihu.com/p/1988193790129902960)            | ⚡️   |
| [sglang_radix_attention.ipynb](./llm_infer)             | [手撕SGLang KV Cache核心逻辑：快速理解RadixAttention](https://zhuanlan.zhihu.com/p/1994495318197305400) | ⚡️   |
| [ulysses_mha_demo.ipynb](./llm_infer)                   | [推理Ulysses并行优化与DeepSeekV3/V3.2实践](https://zhuanlan.zhihu.com/p/1995776941110878482)          | ⚡️   |
| [mini_dl_framework.ipynb](./deeplearning_framework)     | [不用 PyTorch从零实现MLP训练全流程](https://zhuanlan.zhihu.com/p/1988895482320266895)                   | ⚡️⚡️ |
| [pytorch_vista_deepseekV3.ipynb](./pytorch_vista)       | [PyTorch结构可视化：交互式DeepSeekV3计算图](https://zhuanlan.zhihu.com/p/1977414887736112704)            | ⚡️   |
| [LoRA_to_Multi_LoRA.ipynb](./multi_lora)                | [从LoRA到Multi-LoRA：原理&代码实践](https://zhuanlan.zhihu.com/p/1984729458444363168)                 | ⚡️⚡️ |
...
| [vLLM(三)：vLLM显存管理详解](https://zhuanlan.zhihu.com/p/1916529253169734444)                                              | vLLM   | 🔥🔥                                                       |
...
| [0.5x提升:PD分离KV cache传输的实践经验](https://zhuanlan.zhihu.com/p/1946608360259577576)             | vLLM  |
| [0.3x提升:LLM推理优化:MLA算力均衡实践](https://zhuanlan.zhihu.com/p/1950677392017330369)               | vLLM  | 
...
### 直接访问：[**BasicCUDA**](https://github.com/CalvinXKY/BasicCUDA) [https://github.com/CalvinXKY/BasicCUDA](https://github.com/CalvinXKY/BasicCUDA)
